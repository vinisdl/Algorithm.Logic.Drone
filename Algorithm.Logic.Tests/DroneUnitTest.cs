...
namespace Algorithm.Logic.Tests
{
    ...
    public class DroneUnitTest
    {
        ...
        public void Input_NLESSZERO()
        {
            Assert.AreEqual("(999, 999)", Program.Evaluate("N-1"));
        }
        ...
        {
            //Este teste foi alterado pois o Eixo Y corresponde a Norte e o eixo X corresponde a Leste
        ...
        {
            //Este teste foi alterado pois o eixo Y que corresponde a Norte e SUL
        ...
        [TestMethod]
        public void Input_BIGSTRINGWithDiferentValue()
        {
            Assert.AreEqual("(499, 501)", Program.Evaluate(new string(
                Enumerable.Repeat('N', 1001).Concat(
                    Enumerable.Repeat('S', 500)).Concat(
                    Enumerable.Repeat('L', 999)).Concat(
                    Enumerable.Repeat('O', 500)).ToArray())));
        }
    }
}
